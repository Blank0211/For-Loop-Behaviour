...
for l in msg1:
    ...
    #Prints out the remaining elements and their indices in each loop
    ...
    print('The variable l is at index position {0}'.format(index_position))
...
#Printing out the list after executing the For Loop
print('\n', msg1)



print('\nSince 2 is the last index, the For Loop ends.')
print('As you can see from the results; the for loop iterates upon each index\
